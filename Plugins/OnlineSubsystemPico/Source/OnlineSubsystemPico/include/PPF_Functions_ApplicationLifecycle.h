...
PPF_PUBLIC_FUNCTION(ppfLaunchDetailsHandle) ppf_ApplicationLifecycle_GetLaunchDetails();

/// @brief Logs if the user successfully deeplinked to a destination.
PPF_PUBLIC_FUNCTION(void) ppf_ApplicationLifecycle_LogDeeplinkResult(const char *trackingID, ppfLaunchResult result);
