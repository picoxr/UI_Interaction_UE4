...
template<> PICOXRHMD_API UScriptStruct* StaticStruct<FPXREventDataExtDevBatteryEvent>()
{
	...
	struct Z_CompiledInDeferFile_FID_New_0311_Plugins_PICOXR_Source_PICOXRHMD_Public_PXR_HMDTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_New_0311_Plugins_PICOXR_Source_PICOXRHMD_Public_PXR_HMDTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_New_0311_Plugins_PICOXR_Source_PICOXRHMD_Public_PXR_HMDTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_New_0311_Plugins_PICOXR_Source_PICOXRHMD_Public_PXR_HMDTypes_h_2596300691(TEXT("/Script/PICOXRHMD"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_New_0311_Plugins_PICOXR_Source_PICOXRHMD_Public_PXR_HMDTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_New_0311_Plugins_PICOXR_Source_PICOXRHMD_Public_PXR_HMDTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_New_0311_Plugins_PICOXR_Source_PICOXRHMD_Public_PXR_HMDTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_New_0311_Plugins_PICOXR_Source_PICOXRHMD_Public_PXR_HMDTypes_h_Statics::EnumInfo));
