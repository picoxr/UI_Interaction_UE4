...
#define FOREACH_ENUM_EPXRBODYTRACKINGSTATUSCODE(op) \
	op(EPXRBodyTrackingStatusCode::PXR_BODYTRACKING_INVALID) \
	op(EPXRBodyTrackingStatusCode::PXR_BODYTRACKING_VALID) \
	op(EPXRBodyTrackingStatusCode::PXR_BODYTRACKING_LIMITED) 

enum class EPXRBodyTrackingStatusCode : uint8;
template<> struct TIsUEnumClass<EPXRBodyTrackingStatusCode> { enum { Value = true }; };
template<> PICOXRMOTIONTRACKING_API UEnum* StaticEnum<EPXRBodyTrackingStatusCode>();

#define FOREACH_ENUM_EPXRBODYTRACKINGERRORCODE(op) \
	op(EPXRBodyTrackingErrorCode::PXR_BT_ERROR_INNER_EXCEPTION) \
	op(EPXRBodyTrackingErrorCode::PXR_BT_ERROR_TRACKER_NOT_CALIBRATED) \
	op(EPXRBodyTrackingErrorCode::PXR_BT_ERROR_TRACKER_NUM_NOT_ENOUGH) \
	op(EPXRBodyTrackingErrorCode::PXR_BT_ERROR_TRACKER_STATE_NOT_SATISFIED) \
	op(EPXRBodyTrackingErrorCode::PXR_BT_ERROR_TRACKER_PERSISTENT_INVISIBILITY) \
	op(EPXRBodyTrackingErrorCode::PXR_BT_ERROR_TRACKER_DATA_ERROR) \
	op(EPXRBodyTrackingErrorCode::PXR_BT_ERROR_USER_CHANGE) \
	op(EPXRBodyTrackingErrorCode::PXR_BT_ERROR_TRACKING_POSE_ERROR) 

enum class EPXRBodyTrackingErrorCode : uint8;
template<> struct TIsUEnumClass<EPXRBodyTrackingErrorCode> { enum { Value = true }; };
...
#define FOREACH_ENUM_EPXRMOTIONTRACKERCONFIDENCE(op) \
	op(EPXRMotionTrackerConfidence::PXR_STATIC_ACCURATE) \
	op(EPXRMotionTrackerConfidence::PXR_6DOF_ACCURATE) \
	op(EPXRMotionTrackerConfidence::PXR_3DOF_NOT_ACCURATE) \
	op(EPXRMotionTrackerConfidence::PXR_6DOF_NOT_ACCURATE) 

enum class EPXRMotionTrackerConfidence : uint8;
template<> struct TIsUEnumClass<EPXRMotionTrackerConfidence> { enum { Value = true }; };
...
#define FOREACH_ENUM_EPXRBODYTRACKINGMODE(op) \
	op(EPXRBodyTrackingMode::PXR_BTM_DISABLE) \
	op(EPXRBodyTrackingMode::PXR_BTM_WITH_SWIFT) \
	op(EPXRBodyTrackingMode::PXR_BTM_WITHOUT_SWIFT) 

enum class EPXRBodyTrackingMode : uint8;
template<> struct TIsUEnumClass<EPXRBodyTrackingMode> { enum { Value = true }; };
template<> PICOXRMOTIONTRACKING_API UEnum* StaticEnum<EPXRBodyTrackingMode>();

#define FOREACH_ENUM_EPXRBODYTRACKINGGETDATAFLAGS(op) \
	op(EPXRBodyTrackingGetDataFlags::PXR_BODY_NONE) \
	op(EPXRBodyTrackingGetDataFlags::PXR_BODY_POSE) \
	op(EPXRBodyTrackingGetDataFlags::PXR_BODY_ACTION) \
	op(EPXRBodyTrackingGetDataFlags::PXR_BODY_VELO_ACC) 

enum class EPXRBodyTrackingGetDataFlags : uint8;
template<> struct TIsUEnumClass<EPXRBodyTrackingGetDataFlags> { enum { Value = true }; };
template<> PICOXRMOTIONTRACKING_API UEnum* StaticEnum<EPXRBodyTrackingGetDataFlags>();

#define FOREACH_ENUM_EPXRMOTIONTRACKERTYPE(op) \
	op(EPXRMotionTrackerType::PXR_UNKNOWN) \
	op(EPXRMotionTrackerType::PXR_MOTION_TRACKER_1) \
	op(EPXRMotionTrackerType::PXR_MOTION_TRACKER_2) 

enum class EPXRMotionTrackerType : uint8;
template<> struct TIsUEnumClass<EPXRMotionTrackerType> { enum { Value = true }; };
template<> PICOXRMOTIONTRACKING_API UEnum* StaticEnum<EPXRMotionTrackerType>();

#define FOREACH_ENUM_EPXRMOTIONTRACKERMODE(op) \
	op(EPXRMotionTrackerMode::PXR_BODY_TRACKING) \
	op(EPXRMotionTrackerMode::PXR_OBJECT_TRACKING) 

enum class EPXRMotionTrackerMode : uint8;
template<> struct TIsUEnumClass<EPXRMotionTrackerMode> { enum { Value = true }; };
