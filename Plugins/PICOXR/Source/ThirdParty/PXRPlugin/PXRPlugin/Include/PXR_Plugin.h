...
PVRP_EXPORT int Pxr_GetDeviceName(char* name);
...
PVRP_EXPORT	int Pxr_LogSdkApi(char* sdk_buf);
//----------------G3 device-------
...
//----------------ETFR------------------
PVRP_EXPORT PxrResult Pxr_GetEyeTrackingFoveationRenderingSupported(bool* bSupported);
PVRP_EXPORT PxrResult Pxr_GetEyeTrackingFoveationRenderingState(bool* bEnable);
PVRP_EXPORT PxrResult Pxr_SetEyeTrackingFoveationRenderingState(bool bEnable);
PVRP_EXPORT PxrResult Pxr_GetEyeTrackingFoveationRenderingCenter(PxrVector2f* Center);
//----------------ETFR------------------
