...
template<> PICOSPATIALAUDIO_API UScriptStruct* StaticStruct<FPxrAudioSpatializerReverbPluginSettings>()
{
	...
	struct Z_CompiledInDeferFile_FID_UI_Interaction_UE4_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UI_Interaction_UE4_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UI_Interaction_UE4_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UI_Interaction_UE4_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_3493799718(TEXT("/Script/PicoSpatialAudio"),
		Z_CompiledInDeferFile_FID_UI_Interaction_UE4_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UI_Interaction_UE4_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UI_Interaction_UE4_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UI_Interaction_UE4_Plugins_PicoSpatialAudio_Source_PicoSpatialAudio_Private_PxrAudioSpatializerReverb_h_Statics::ScriptStructInfo),
		nullptr, 0);
